...
FileN = Label(root, text="Enter File Name:", width=20, height=2, bg="black", fg="white")
FileN.grid(row=1, column=0, padx=10, pady=10)

entry = Entry(root, width=40, bg="black", fg="white")
...
entry2 = Entry(root, width=40, bg="black", fg="white")
...
entry3 = Entry(root, width=40, bg="black", fg="white")
...
entry4 = Entry(root, width=40, bg="black", fg="white")
